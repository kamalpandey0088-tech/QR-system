      ...
      >
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-[0_30px_60px_rgba(0,0,0,0.4)]">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <Link href="/kitchen" className="block mt-6">
              <button className="group w-full flex items-center justify-center gap-2 bg-white text-gray-900 py-4 rounded-2xl font-bold text-[16px] active:scale-95 transition-all shadow-[0_10px_20px_rgba(255,255,255,0.1)] hover:shadow-[0_15px_30px_rgba(255,255,255,0.2)]">
